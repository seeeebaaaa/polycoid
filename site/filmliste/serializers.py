...
class MovieSerializer(serializers.ModelSerializer):
    ...
    providers_flatrate = WatchProviderSerializer(many=True, read_only=True)
    providers_rent = WatchProviderSerializer(many=True, read_only=True)
    providers_buy = WatchProviderSerializer(many=True, read_only=True)
